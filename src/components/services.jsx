...
function Services() {
  return (
    <div className='bg-gray-50'>
        ...
        <div className='border-1 text-center p-5 border-gray-200 shadow-md hover:shadow-purple-200 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 bg-white/80 backdrop-blur-md'>
