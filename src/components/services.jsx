...
function Services() {
  return (
    <div className='bg-gray-50'>
        ...
        <div className='border text-center p-10 border-gray-200 origin-bottom shadow-md hover:shadow-purple-200 hover:shadow-lg hover:scale-105 transition-all duration-300 bg-white/80'>
