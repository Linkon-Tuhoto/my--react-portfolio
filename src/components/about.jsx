...
function About() {
  return (
    ...
    <div className='grid md:grid-cols-2 grid-cols-1 gap-3 p-10 px-6 sm:px-10 md:px-20 lg:px-32 py-10 sm:py-14 md:py20 items-center text-[16px] leading-[1.8] text-[#4B5563] '>
        ...
        <div>
            ...
            <button className='bg-amber-600 px-5 py-2 rounded text-amber-50 text-xl mt-3'>Read More</button>
        </div>
    </div>
    </section>
  )
