    ...
    return(
        ...
        <div className="flex items-center justify-between ">
            <div className="text-blue-800 m-5 grid grid-flow-col gap-5 ">
                ...
                <h1 className="text-2xl md:text-3xl flex justify-center items-center inset-0">Ticon</h1>
            </div>
            <div className="">
                <ul className="md:grid md:grid-flow-col md:justify-center md:gap-10 md:mr-20 hidden m-5 font-bold">
            ...
            {open && (
            <ul className="grid grid-flow-row justify-center gap-10 md:hidden bg-white/80 backdrop-blur-md shadow-lg absolute top-full w-8/12 right-0 rounded-l-2xl shadow p-10 pb-[100%] mb-0 font-bold ">
