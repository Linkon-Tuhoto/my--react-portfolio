...
function Projects() {
  return (
    <div className='bg-white grid grid-cols-1 md:grid-cols-3 gap-10 p-15'>
        <div className='bg-purple-50 p-6 rounded-2xl border border-purple-200 shadow-sm hover:shadow-[0_10px_30px_rgba(168, 85, 247,0.9)]'>
            <img src="" alt="picture" />
            <h2 className='text-gray-900 font-semibold text-xl mb-1'>School Management Website</h2>
        ...
        <div className='bg-purple-50 p-6 rounded-2xl border border-purple-200 shadow-sm hover:shadow-[0_10px_30px_rgba(168, 85, 247,0.9)]'>
            <img src="" alt="picture" />
            <h2 className='text-gray-900 font-semibold text-xl mb-1'>E-commerce Website</h2>
