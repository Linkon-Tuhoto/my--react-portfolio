...
function Projects() {
  return (
    ...
    <div className='bg-white'>
        <h2 className='text-center text-gray-950 font-bold text-3xl sm:4xl md:5xl pt-3'>My Projects</h2>
    <div className='grid grid-cols-1 md:grid-cols-3 gap-10 p-5 md:p-15'>
